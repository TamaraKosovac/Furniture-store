# CozyHaven - salon namještaja

**CozyHaven** je aplikacija namijenjena zaposlenima u salonu namještaja. Omogućava jednostavnu manipulaciju zaposlenima, proizvodima, izdavanjima računa, te samim računima. Dodatno, aplikacija podržava promjenu jezika i teme.
...
## Početna stranica 
Početna stranica sadrži login formu sa poljima za unos korisničkog imena i lozinke. Na ovaj način je omogućena prijava kako administratora tako i zaposlenih.
...
## Administratorska stranica
Administrator ima sljedeće mogućnosti:

- **Osnovne mogućnosti manipulacije nad zaposlenima:**

  - Pregled osnovnih informacija o zaposlenima
  ...
  - Dodavanje, izmjena, brisanje i pretraga zaposlenih
...
- **Promjenu teme, jezika i svog profila:**

  - Tri dostupne teme: **svijetla**, **siva** ili **tamna**
  - Dva dostupna jezika: **srpski** i **engleski**
...
## Stranica za zaposlene
Zaposleni imaju sljedeće mogućnosti: 

- **Osnovne mogućnosti manipulacije nad kategorijama:**
  ...
  - Dodavanje, izmjena, brisanje i pretraga kategorija
...
- **Osnovne mogućnosti manipulacije nad proizvodima:**
  ...
  - Pregled, dodavanje, izmjena, brisanje i pretraga proizvoda po kategorijama
...
- **Izdavanje računa:**
  ...
  - Zaposleni ima mogućnost pregleda svih dostupnih proizvoda

   ![screenshot](Screenshots/issueBill.png)

  - Bira proizvode koji će se naći na računu

   ![screenshot](Screenshots/issueBillSelect.png)

  - Nakon uspješnog plaćanja, prikazuje se odgovarajuća poruka

   ![screenshot](Screenshots/issuedBill.png)

- **Pregled računa:**

  - Zaposleni mogu da pogledaju sve izdate račune

   ![screenshot](Screenshots/bills.png)

  - Mogu da pretraže račune po datumu

   ![screenshot](Screenshots/billsFilterByDate.png)

  - Ukoliko nema računa za željeni datum, prikazuje se odgovarajuća poruka

   ![screenshot](Screenshots/billsNoResultOfFilter.png)

- **Promjenu teme i jezika:**
